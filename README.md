...
| test2 | 1 | 1 | 0 | line51 | chr2 | 240982213 | C | G | PRR21:NM_001080835 | NA | 7 | HLA-C*01:02 | SSTPLHPCPF | STPLHPCPF | 0 | 1 | 1 | 0 | 0 | SSTPLHPCPF | line51_NM_00108 | 0.13137 | 2.00 | <= | WB | 1 |
   ...
   Note that the above output follows the notation generated by **netMHCpan-4.0**. If using netMHCpan-4.1, additional columns are included evaluating binding affinity, placed between **Identity** and **Candidate**: Score_EL | %Rank_EL | Score_BA | %Rank_BA | Aff(nM), as specified [here](http://www.cbs.dtu.dk/services/NetMHCpan-4.1/output.php).
