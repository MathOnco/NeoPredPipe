...
class MyTestCase(unittest.TestCase):
    def test_genotypeformat_ad(self):
        ...
        self.assertEqual(DefineGenotypeFormat(line_ad), ('alldepths', 1))
    ...
    def test_genotypeformat_a(self):
        ...
        self.assertEqual(DefineGenotypeFormat(line_a), ('allele', 1))
    ...
    def test_genotypeformat_nv(self):
        ...
        self.assertEqual(DefineGenotypeFormat(line_nv), ('numvarreads', 4))
